...
if (guess !== sil){
  alert(`Thank you for playing! Unfortunately, you didn't guess it in the ${attempt} tries. I have ${sil} sister-in-laws`);
}
...
alert(`You scored ${score}/7. I hope you enjoy the website ${visitorName} :) `);
