...
// if (guess !== sil){
//   alert(`Thank you for playing! Unfortunately, you didn't guess it in the it in the ${attempt} tries. I have ${sil} sister-in-laws`);
// }

/*
  As a user, I would like to guess the answer to a question that could have many possibilities so that I can have fun with with a guessing game.

  1. Add a 7th question that has multiple possible correct answers that are stored in an array.
  2. Give the user 6 attempts to guess the correct answer.
  3. The guesses will end once the user guesses a correct answer or they run out of attempts.
  4. Display all the possible correct answers to the user.
  5. Consider using a loop of some sort for this question.
  6. As a user, I would like to know my final score so that I can know how well I did.

  Keep track of the total number of correct answers. At the end tell them how many they got correct out of the 7 questions asked.
*/

let question7 = 'what are some of my favorite drinks? Your choices are black tea, smoothie, coffee, water, juice, boba tea';
